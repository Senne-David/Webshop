...
VALUES 
('david1', 'david', 'senne', 'david', '04/09/2003', '2200', 'wuytsbergen', '8', 'senne.david@telenet.be', '0468/27.62.57'),
('verslype1', 'verslype', 'robbe', 'verslype', '02/06/2003', '2222', 'wiekevorstplein', '8', 'robbe.verslype@telenet.be', '0468/30.42.96'),
('smeyers1', 'smeyers', 'tom', 'smeyers', '08/08/2003', '2462', 'de bergen', '41', 'tom.smeyers@telenet.be', '0465/65.12.78');
...
AUTO_INCREMENT = 1
DEFAULT CHARACTER SET = utf8;
INSERT INTO `webshop_database`.`winkelwagen` (`Datum`, `Verzendkosten`, `Kaartnummer`, `Verzendmethode`, `FK_Klant`)
VALUES
('01/01/2021', '5', 'BE123456789', 'afhalen', '1'),
('12/01/2021', '5', 'BE987654321', 'bezorgen', '2'),
('03/02/2021', '5', 'BE965874235', 'bezorgen', '3');
